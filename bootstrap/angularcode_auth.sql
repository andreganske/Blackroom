...
CREATE TABLE IF NOT EXISTS `customers_auth` ( `uid` int(11) NOT NULL AUTO_INCREMENT, `name` varchar(50) NOT NULL, `email` varchar(50) NOT NULL, `password` varchar(200) NOT NULL, `created` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY (`uid`));
...
('Trisha Tamanna Priyadarsini', 'trisha@gmail.com', '$2a$10$c9b32f5baa3315554bffcuWfjiXNhO1Rn4hVxMXyJHJaesNHL9U/O', '2014-08-31 18:32:03'),
...
('Manas Ranjan Subudhi', 'manas@gmail.com', '$2a$10$03ab40438bbddb67d4f13Odrzs6Rwr92xKEYDbOO7IXO8YvBaOmlq', '2014-08-31 20:45:08'),
('AngularCode Administrator', 'admin@angularcode.com', '$2a$10$72442f3d7ad44bcf1432cuAAZAURj9dtXhEMBQXMn9C8SpnZjmK1S', '2014-08-31 21:00:26');
